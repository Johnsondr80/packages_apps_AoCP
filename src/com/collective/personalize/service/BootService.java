...
import com.collective.personalize.fragments.ColorTuningPreference;
import com.collective.personalize.fragments.GammaTuningPreference;
import com.collective.personalize.R;
import com.collective.personalize.tools.Voltage;
import com.collective.personalize.tools.VoltageControl;
import com.collective.personalize.util.CMDProcessor;
import com.collective.personalize.util.KernelUtils;
...
public class BootService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        try {
            ...
            bwriter.close();
            Intent i = new Intent();
            i.setAction("com.collective.personlize.FCHARGE_CHANGED");
