...
public class AoCPActivity extends PreferenceActivity implements ButtonBarHandler {

    private static final String TAG = "AoCP_Personalize";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getAction().equals("com.collective.personalize.START_NEW_FRAGMENT")) {
            String className = getIntent().getStringExtra("collective_fragment_name").toString();
            if (!className.equals("com.collective.personalize.AoCPActivity")) {
                Bundle b = new Bundle();
