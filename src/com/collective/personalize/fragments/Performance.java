...
import com.collective.personalize.tools.VoltageControl;
import com.collective.personalize.util.CMDProcessor;
import com.collective.personalize.util.Helpers;

public class Performance extends COLLECTIVEPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.collective.personalize.fragments.ColorTuningPreference ct = (com.collective.personalize.fragments.ColorTuningPreference) findPreference("color_tuning");
        com.collective.personalize.fragments.GammaTuningPreference gt = (com.collective.personalize.fragments.GammaTuningPreference) findPreference("gamma_tuning");
        if (!hasColorTuning) {
