 ...
 */
public class COLLECTIVEPreferenceFragment extends PreferenceFragment implements DialogCreatable {
    ...
    public static class SettingsDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if (savedInstanceState != null) {
                ...
                if (mParentFragment instanceof COLLECTIVEPreferenceFragment) {
                    // restore mDialogFragment in mParentFragment
                    ((COLLECTIVEPreferenceFragment) mParentFragment).mDialogFragment = this;
                }
            }
        ...
        public void onDetach() {
            ...
            if (mParentFragment instanceof COLLECTIVEPreferenceFragment) {
                ...
                if (((COLLECTIVEPreferenceFragment) mParentFragment).mDialogFragment == this) {
                    ((COLLECTIVEPreferenceFragment) mParentFragment).mDialogFragment = null;
                }
            }
        }
    }
